...
if __name__ == '__main__':
    file = pd.read_excel('Q(0.5)ThroughPlane.xlsx')
    ...
    plt.text(Final_Time+80, maxT, f"Q ={Q_Val}",color = 'orange', ha = 'center' )
    plt.text(Final_Time+80, minT, f"Q ={0}", color='pink', ha='center')
